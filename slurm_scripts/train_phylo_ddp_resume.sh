#!/bin/bash
#SBATCH --job-name=modernBERT_1B_phylo_aligned_resume
...
#SBATCH --output=/gpfs/data/brandeslab/User/as12267/slurm_outputs/modernBERT_1B_phylo_aligned_resume_%j.out
#SBATCH --error=/gpfs/data/brandeslab/User/as12267/slurm_outputs/modernBERT_1B_phylo_aligned_resume_%j.err
...
echo "Launching DDP resume training..."
...
#
# Effective batch = 28 × 8 × 5 = 1120 seqs per optimizer step
#
# run_name and output_dir match the original training so the resumed
# training continues writing checkpoints alongside existing ones
# (checkpoint-18000 -> checkpoint-19500 -> checkpoint-21000 ...).
# ─────────────────────────────────────────────────────────────
...
srun \
  ...
  torchrun \
    ...
    /gpfs/data/brandeslab/User/as12267/PhylogeneticTraining/python_scripts/train_pre_trained_modernBERT.py \
    --run_name modernBERT_1B_phylo_aligned_23844331 \
    --ckpt_path /gpfs/data/brandeslab/phylo_llm_checkpts/long_training/modernBERT_1B_phylo_aligned_23844331/checkpoint-18000 \
